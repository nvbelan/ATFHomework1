...
public class ParametrTest extends BaseClass {

    @Test
    public void bodeTest() throws InterruptedException {
        ...
        fillInputField(driver.findElement(By.xpath(xPathLastName)), lastName);
        fillInputField(driver.findElement(By.xpath(xPathFirstName)), firstName);
        fillInputField(driver.findElement(By.xpath(xPathMiddleName)), middleName);
        fillInputField(driver.findElement(By.xpath(xPathBirthDate)), birthDate);
        fillInputField(driver.findElement(By.xpath(xPathEmail)), eMail);
